...
サポートページがないとダメだと言われたので、サポートページをつくった。

https://tkgstrator.work/?page\_id=28364

Discord で直接言ってもらうのでも構わないが、サーバに書き込むのは気が引けるという方のために匿名で要望を書けるようにした。

テンプレートもあるので、書き方がわからないということはないと思う。
...
https://github.com/bizz84/SwiftyStoreKit/issues/506
