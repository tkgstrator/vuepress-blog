...
@disabled
0104C94C 600E0090 // ADRP X0, #0x1CC000
0104C950 007047F9 // LDR X0, [X0, #0xEE0]
0104C954 000040F9 // LDR X0, [X0]
0104C958 01B841F9 // LDR X1, [X0, #0x370]
0104C95C 21084091 // ADD X1, X1, #0x2000
0104C960 213C1C91 // ADD X1, X1, #0x70F
0104C964 01B801F9 // STR X1, [X0, #0x370]
0104C968 C0035FD6 // RET
```
